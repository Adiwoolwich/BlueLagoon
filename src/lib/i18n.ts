...
const de = {
  ...
  privacyMap: "Karte:",
  privacyMapP: "Satelliten- und Straßenkarten von Esri (World Imagery, World Transportation, Retina) und Ortsnamen von CARTO (voyager_only_labels, OSM-Lokalnamen). Dafür ist die IP-Adresse technisch nötig.",
  privacyLoc: "Standort:",
...
const en: Record<keyof typeof de, string> = {
  ...
  privacyMap: "Map:",
  privacyMapP: "Satellite and road map tiles from Esri (World Imagery, World Transportation, retina) and place names from CARTO (voyager_only_labels, OSM local names). An IP address is technically required.",
  privacyLoc: "Location:",
...
const nl: Record<keyof typeof de, string> = {
  ...
  privacyMap: "Kaart:",
  privacyMapP: "Satelliet- en wegenkaarten van Esri (World Imagery, World Transportation, retina) en plaatsnamen van CARTO (voyager_only_labels, OSM-lokale namen). Daarvoor is het IP-adres technisch nodig.",
  privacyLoc: "Locatie:",
